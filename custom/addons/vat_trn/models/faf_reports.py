...
class CSVExportXLSX(models.AbstractModel):
    _name = 'report.vat_trn.faf_report'
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        worksheet = workbook.add_worksheet('FAF Report')
        ...
        row = row + 1
        col = 0
        worksheet.write(row, col, vendor_bills_footer['purchase_data_end'])
        worksheet.write(row, col + 1, vendor_bills_footer['total_purchase_amount'])
        worksheet.write(row, col + 2, vendor_bills_footer['total_purchase_tax_amount'])
        worksheet.write(row, col + 3, vendor_bills_footer['transaction_count'])
        ...
        row = row + 1
        col = 0
        worksheet.write(row, col, invoices_footer['purchase_data_end'])
        worksheet.write(row, col + 1, invoices_footer['total_purchase_amount'])
        worksheet.write(row, col + 2, invoices_footer['total_purchase_tax_amount'])
        worksheet.write(row, col + 3, invoices_footer['transaction_count'])
        ...
        for i in gl_data:
            row = row + 1
            col = 0
            worksheet.write(row, col, i['gldate'])
            worksheet.write(row, col+1, i['code'])
            worksheet.write(row, col+2, i['account_name'])
