...
class FleetVehicle(models.Model):
    ...
    front_r_door_dent = fields.Boolean(string="Front Door (R) Dent", default=True)
    front_l_door_dent = fields.Boolean(string="Front Door (L) Dent", default=True)
    back_r_door_dent = fields.Boolean(string="Back Door (R) Dent", default=True)
    back_l_door_dent = fields.Boolean(string="Back Door (L) Dent", default=True)
    boot_dent = fields.Boolean(string="Boot Dent", default=True)
    # dent charges
    hood_dent_cost = fields.Float(string="Hood Dent Cost")
    front_r_door_dent_cost = fields.Float(string="Front Door (R) Cost")
    front_l_door_dent_cost = fields.Float(string="Front Door (L) Cost")
    back_r_door_dent_cost = fields.Float(string="Back Door (R) Cost")
    back_l_door_dent_cost = fields.Float(string="Back Door (L) Cost")
    boot_dent_cost = fields.Float(string="Boot Cost")
    # dent count
    hood_dent_count = fields.Integer(string="Hood Dent Count")
    front_r_door_dent_count = fields.Integer(string="Front Door (R) Dent Count")
    front_l_door_dent_count = fields.Integer(string="Front Door (L) Dent Count")
    back_r_door_dent_count = fields.Integer(string="Back Door (R) Dent Count")
    back_l_door_dent_count = fields.Integer(string="Back Door (L) Dent Count")
    boot_dent_count = fields.Integer(string="Boot Dent Count")

    hood_dent_count_new = fields.Integer(string="Hood Dent Count New")
    front_r_door_dent_count_new = fields.Integer(string="Front Door (R) Count New")
    front_l_door_dent_count_new = fields.Integer(string="Front Door (L) Count New")
    back_r_door_dent_count_new = fields.Integer(string="Back Door (R) Count New")
    back_l_door_dent_count_new = fields.Integer(string="Back Door (L) Count New")
    boot_dent_count_new = fields.Integer(string="Boot")

    # scratches
    hood_scratch = fields.Boolean(string="Hood Scratch", default=True)
    front_r_door_scratch = fields.Boolean(string="Front Door (R) Scratch", default=True)
    front_l_door_scratch = fields.Boolean(string="Front Door (L) Scratch", default=True)
    back_r_door_scratch = fields.Boolean(string="Back Door (R) Scratch", default=True)
    back_l_door_scratch = fields.Boolean(string="Back Door (L) Scratch", default=True)
    boot_scratch = fields.Boolean(string="Boot Scratch", default=True)
    # scratch scratches
    hood_scratch_cost = fields.Float(string="Hood Scratch Cost")
    front_r_door_scratch_cost = fields.Float(string="Front Door (R) Scratch Cost")
    front_l_door_scratch_cost = fields.Float(string="Front Door (L) Scratch Cost")
    back_r_door_scratch_cost = fields.Float(string="Back Door (R) Scratch Cost")
    back_l_door_scratch_cost = fields.Float(string="Back Door (L) Scratch Cost")
    boot_scratch_cost = fields.Float(string="Boot Scratch Cost")
    # scratch scratches
    hood_scratch_count = fields.Integer(string="Hood Count")
    front_r_door_scratch_count = fields.Integer(string="Front Door (R) Count")
    front_l_door_scratch_count = fields.Integer(string="Front Door (L) Count")
    back_r_door_scratch_count = fields.Integer(string="Back Door (R) Count")
    back_l_door_scratch_count = fields.Integer(string="Back Door (L) Count")
    boot_scratch_count = fields.Integer(string="Boot Count")

    hood_scratch_count_new = fields.Integer(string="Hood Count New")
    front_r_door_scratch_count_new = fields.Integer(string="Front Door (R) Count New")
    front_l_door_scratch_count_new = fields.Integer(string="Front Door (L) Count New")
    back_r_door_scratch_count_new = fields.Integer(string="Back Door (R) Count New")
    back_l_door_scratch_count_new = fields.Integer(string="Back Door (L) Count New")
    boot_scratch_count_new = fields.Integer(string="Boot Count New")
    # Fuel
