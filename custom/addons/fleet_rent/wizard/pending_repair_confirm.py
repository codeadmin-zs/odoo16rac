...
class PendingRepairConfirm(models.TransientModel):
    ...
    def confirm_wo_forcefully(self):
        ...
        #         raise Warning(_("Next service days is not configured for %s please set it from configuration!") % (wo_obj.vehicle_id.name))
        #     work_order_vals = {}
        ...
        #     next_service_date = \
        #         datetime.strptime(str(work_order.date),
